...
legend_elements = [
                   ...
                   Line2D([0], [0], marker='s', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='B - Smith et al. (2018)'),
                   Line2D([0], [0], marker='p', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='C - Kalińska-Nartiša et al. (2017)'),
                   Line2D([0], [0], marker='*', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='D - Sweet and Brannan (2016)'),
                   Line2D([0], [0], marker='H', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='E - Stevic (2015)'),
                   Line2D([0], [0], marker='^', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='F - Mahaney et al. (1996)'),
                   Line2D([0], [0], marker='P', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='G - Nartišs and Kalińska-Nartiša\n(2017)'),
                   Line2D([0], [0], marker='D', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='H - Deane (2010)'),
                   Line2D([0], [0], marker='X', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='I - Sweet and Soreghan (2010)'),
                   Line2D([0], [0], marker='d', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='J - Mahaney et al. (2001)'),
                   Line2D([0], [0], marker='v', color='w',
                          markerfacecolor='w', markeredgecolor='k', ms=10,
                          label='K - Mahaney and Kalm (1995)'),
                   Patch(facecolor='#ffffff', label=''),
                   Patch(facecolor='#ffffff', label=''),
                   Patch(facecolor='#ffffff', label=''),
                   ...
                   Patch(facecolor='#ffffff', label=''),
                   # Patch(facecolor='#ffffff', label='Crescentic Gouges'),
